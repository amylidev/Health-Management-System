<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="seBP.aspx.cs" Inherits="Health.seBP" %>
    ...
    <form id="form1" runat="server">
        ...
        <br />
            <div style="width:280px; margin:0 auto">
                <asp:Calendar ID="Calendar1" runat="server" BackColor="White" BorderColor="#999999" CellPadding="4" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" Height="181px" Width="275px">
            ...
            <br />
        <asp:Button ID="ChoseDate" runat="server" OnClick="ChoseDate_Click" Text="查詢" Height="27px" />
            </div>
            <div style="text-align:center;">
        <asp:Label ID="BloodTitle" runat="server" ForeColor="Red"></asp:Label>
                    <br />
        <asp:Chart ID="BloodChart" runat="server" Height="295px" Width="760px">
            <Series>
        ...
        <div style="width:180px; position:absolute; left:170px; text-align:center; z-index:20">
            <br />
