<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="seBoth.aspx.cs" Inherits="Health.seBoth" %>
    ...
    <form id="form1" runat="server">
        ...
        <div style="height:340px; width:420px; float:left; margin-left:80px; text-align:center;">
            <br />
                    ...
                    <asp:Calendar ID="Calendar1" runat="server" BackColor="White" BorderColor="#999999" CellPadding="4" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" Height="220px" Width="311px" SelectionMode="DayWeek">
                    ...
                    <br />
                    <asp:Button ID="ChoseDate" runat="server" Text="查詢" OnClick="ChoseDate_Click" style="width: 60px; height: 32px;" />
                    <br />
           </div>
           <div style="height:280px; width:660px; float:left; margin-left:60px; text-align:center;">
               <div style="width:220px; margin:0 auto">
                    <asp:Label ID="GridTitle" runat="server"></asp:Label>
                    <asp:GridView ID="SugarGrid" runat="server" AutoGenerateColumns="False" Width="207px" DataSourceID="SqlDataSource1">
                        <Columns>
        ...
        <div style="clear:both;"> </div>
            <div  style="width:620px; margin:0 auto; float:left; margin-left:50px; text-align:center;">
                <asp:Label ID="BloodTitle" runat="server" ForeColor="Red"></asp:Label>
                    <br />
                    <asp:Chart ID="BloodChart" runat="server" Height="250px" Width="680px">
                        <Series>
                ...
                <div style="width:620px; margin:0 auto; float:left; margin-left:40px; text-align:center;">
            <br />
            <span>
                 <asp:Label ID="SugarTitle" runat="server" ForeColor="Red"></asp:Label>
            </span>
            <br />
                    <asp:Chart ID="SugarChart" runat="server" Height="250px" Width="680px">
                        <Series>
                            <asp:Series Name="Series1">
                            </asp:Series>
                        </Series>
        ...
        <div style="width:180px; position:absolute; left:180px; text-align:center; z-index:20">
         ...
         <div  style="position:absolute; left:420px; z-index:1; background-size:cover;">
            <img src="查詢-護士.png" alt="iCareÜ"  width="330" height="280" title="iCareÜ"
             ...
             <div style="width:180px; position:absolute; left:525px; text-align:center;  z-index:20">
                 <br />
