<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reBS.aspx.cs" Inherits="Health.reBS" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div style=" text-align:center; position:absolute; right:12px; z-index:1;">
            ...
            <br />
            <br />
            <asp:Label ID="LBtime" runat="server" Text="請選取欲修改時段:"></asp:Label>
           &nbsp;
           <asp:DropDownList ID="datelist" runat="server" AutoPostBack="True" OnSelectedIndexChanged="datelist_SelectedIndexChanged" >
               <asp:ListItem>請選擇</asp:ListItem>
                ...
                <br />
                <br />
                <asp:Label ID="LBnewtime" runat="server" Text="紀錄時間："></asp:Label>
                &nbsp;
                <asp:TextBox ID="newtime" runat="server" AutoComplete="off" BorderColor="#E3D7CE" BorderStyle="Solid" BorderWidth="5px" Width="145px"></asp:TextBox>
                </div>
            <div style="height:480px; width:420px; float:left; margin-left:90px;">
            <br />
            <br />
                <asp:Label ID="LBSbefore" runat="server" Text="修改前血糖值:"></asp:Label>
                &nbsp;
                <asp:Label ID="Sbefore" runat="server" Text=""></asp:Label>
            <br />
            <br />
            <asp:Label ID="LBbsugar" runat="server" Text="修改後血糖值:"></asp:Label>
            &nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="bsugar" runat="server" AutoComplete="off" BorderColor="#E3D7CE" BorderStyle="Solid" BorderWidth="5px"></asp:TextBox>
            <br /> <br /><br />
                <img src="時鐘.png" alt="iCareÜ" width="200" height="200""
                style="display:block;"/><br />
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button1" runat="server" Text="修改" OnClick="Button1_Click" Height="31px" Width="74px" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Label ID="show" runat="server" Text=""></asp:Label><asp:Label ID="sucess" runat="server" Text="" forecolor="Red"></asp:Label>
            <br />
            </div>
        <div style="height:400px; width:300px;float:left; margin-left:70px; margin-top:95px;">
            <img src="修改-送出山羊醫生.png" alt="iCareÜ" width="300" height="400"
                style="display:block; "/>
        </div>
