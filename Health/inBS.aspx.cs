...
namespace Health
{
    public partial class inBS : System.Web.UI.Page
    {
        ...
        protected void Button_send_Click(object sender, EventArgs e)
        {
            ...
            string s = "INSERT INTO BS VALUES( '" + Session["Num"].ToString() + " ' , '" + TextBox_date.Text + "','" + TextBox_time.Text
                + "','" + TextBox_BS.Text + "',NULL,NULL)";
            Label1.Text = db.ExecuteUpdate(s);
            Label1.Visible = true;
            Label_result.Text = "日期:" + TextBox_date.Text + "<br>" + "時間:" + time + "<br>" + "血糖:" + TextBox_BS.Text;
            TextBox_date.Text = "";
            TextBox_BS.Text = "";
        }
    }
