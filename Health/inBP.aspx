<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="inBP.aspx.cs" Inherits="Health.inBP" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="height:560px; width:340px; float:left; margin-left:80px; text-align:center;">
            <br />
            ...
            <br /> <br />
            <asp:Label ID="Label_DBP" runat="server" Text="舒張壓："></asp:Label>
            <asp:TextBox ID="TextBox_DBP" runat="server" AutoComplete="off" BorderColor="#E3D7CE" BorderStyle="Solid" BorderWidth="5px"></asp:TextBox>
            <br />
            <br />
            <img src="新增-量血壓的手.jpg" alt="iCareÜ" width="200" height="200""
                style="display:block; margin:auto;"/><br />
            </div>
             <div style="height:540px; width:400px; float:left; margin-left:70px; text-align:center;">
                 <br />
            ...
            <img src="時鐘.png" alt="iCareÜ" width="200" height="200""
                style="display:block; margin:auto;"/><br />
            <asp:Label ID="Label_SBP" runat="server" Text="收縮壓："></asp:Label>
            <asp:TextBox ID="TextBox_SBP" runat="server" AutoComplete="off" BorderColor="#E3D7CE" BorderStyle="Solid" BorderWidth="5px"></asp:TextBox>
            <br /><br />
                 <img src="新增-量血壓.jpg" alt="iCareÜ" width="200" height="200""
                style="display:block; margin:auto;"/><br />
                 </div>
           <div style="height:560px; width:420px; float:left; margin-left:50px; text-align:center;">
                  <br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /> <br /> <br /> <br />
                  <br />
                  <br />
            <asp:Button ID="Button_send" runat="server" Height="37px" OnClick="Button_send_Click" Text="送出" Width="73px" />
            <br /><br />
            <asp:Label ID="Label1" runat="server" ForeColor="Red"></asp:Label>
               <br />
            <asp:Label ID="Label_result" runat="server" ></asp:Label>
             <img src="新增-送出女醫坐.jpg" alt="iCareÜ" width="200" height="400""
                style="display:block; position:relative; bottom:46%; left:270px;"/><br />
        </div>
             </div>
